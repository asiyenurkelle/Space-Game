...
public class Player extends GameObject {
	 ...
	 //cooldown iki ateþ arasýndaki beklemesüremiz ardarda ateþ etmememsi için.//
	...
	public void move() {
		...
		// hareket ederken hýz*zaman kadar yer deðiþtiririz.Y'i yerdeðiþtirme kadar azalttýk.//
...
// karakterin ekranda durmasýný saðladýk ekranýn sýnýrlarýný aþmamasý için.//
